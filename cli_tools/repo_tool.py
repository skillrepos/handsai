...
def do_search(pattern, max_results=20):
    """Search the inventory service source for a pattern. Returns structured matches."""
...
def do_tests():
    """Run the inventory service's tests and return a structured summary."""
...
def build_parser():
    ...
    p = sub.add_parser("search", help="Search inventory service source code for a regex pattern.")
    ...
    sub.add_parser("tests", help="Run the inventory service test suite and summarize results.")
